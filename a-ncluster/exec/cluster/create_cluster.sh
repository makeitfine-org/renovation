...
#`docker network ls` and with `docker network inspect ...` to wind (network with 192.168.50.*)
#docker network rm <network_name> (network with 192.168.50.*)

minikube start -p ${CLUSTER_NAME} --memory 4096 --cpus 4  --subnet 192.168.50.2
