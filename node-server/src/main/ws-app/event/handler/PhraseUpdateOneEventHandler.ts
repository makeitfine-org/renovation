...
export class PhraseUpdateOneEventHandler extends PhraseEventHandler {
  readonly eventType: EventType = EventType.PHRASE_UPDATE_ONE

  handleInside(phraseData: PhraseData): null {
    this.phraseService.updatePhrase(phraseData.phrase!!)
    return null
  }
}
