...
import {PhraseRemoveOneEventHandler} from "@main/ws-app/event/handler/PhraseRemoveOneEventHandler"
...
class EventHandlerFacade {
  ...
  private constructor() {
    ...
    EventHandlerFacade.handlers.push(new PhraseRemoveOneEventHandler())
  }
