...
@Component
public class EventTopicWorkEventKafkaConsumer extends KafkaConsumer<WorkEventKey, WorkEvent> {

    public EventTopicWorkEventKafkaConsumer(@Value("${spring.kafka.topic.event.name}") String topicName) {
        super(topicName);
    }
