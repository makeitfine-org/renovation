...
minikube ssh -- "sudo chown -R 1001:1001 /mnt/data/postgres/master"
...
minikube ssh -- "sudo mkdir /mnt/data/redis/master"
minikube ssh -- "sudo chown -R 1001:1001 /mnt/data/redis/master"
