...
alias kpp="kubectl patch pv postgres-primary-0-pv -p '{\"spec\":{\"claimRef\": null}}' && kubectl patch pv postgres-replica-0-pv -p '{\"spec\":{\"claimRef\": null}}' && kubectl patch pv mongodb-master-0-pv -p '{\"spec\":{\"claimRef\": null}}'"
